...
#bowtie2/2.1.0, samtools/1.7, mummer/4
...
nucmer --maxmatch --nosimplify ${W_URL}/freebayes_round1/${CONTIG} ${W_URL}/freebayes_round1/${CONTIG} -f --delta "${W_URL}/trimmed/${FNAME}.delta" -b 5000 -t ${NPROC} 
...
nucmer --maxmatch --nosimplify "${W_URL}/trimmed/${FNAME}_new.fasta" "${W_URL}/trimmed/${FNAME}_new.fasta" -f --delta "${W_URL}/trimmed/${FNAME}.delta" -b 5000 -t ${NPROC} 
...
echo ">${FNAME}" > "${W_URL}/trimmed/${FNAME}_10x1.fasta" & grep -v ">" ${W_URL}/freebayes_round1/${CONTIG} | tr -d '\n' | cut -c${MIDDLE} >> "${W_URL}/trimmed/${FNAME}_10x1.fasta"
...
sed -i "$ s/$/$S/" ${W_URL}/trimmed/${FNAME}_10x1.fasta

printf "$(sed -n 1p ${W_URL}/trimmed/${FNAME}_10x1.fasta)\n$(sed -n 2p ${W_URL}/trimmed/${FNAME}_10x1.fasta | cut -c$(( $(sed -n 2p ${W_URL}/trimmed/${FNAME}_10x1.fasta | tr -d '\n' | wc -c) - 100 ))-$(sed -n 2p ${W_URL}/trimmed/${FNAME}_10x1.fasta | tr -d '\n' | wc -c))$(sed -n 2p ${W_URL}/trimmed/${FNAME}_10x1.fasta)$(sed -n 2p ${W_URL}/trimmed/${FNAME}_10x1.fasta | cut -c1-100)" > ${W_URL}/trimmed/${FNAME}_10x1_final.fasta