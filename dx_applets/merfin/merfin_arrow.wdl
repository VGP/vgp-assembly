...
task merfin_arrow{
    ...
    command <<<
        ...
        ls -lh
        /merfin/build/bin/merfin -vmer -memory1 30 -memory2 150 -comb 15 -sequence sequence.fasta -seqmers seqdbmeryl/all_count/union.meryl -readmers readdbmeryl/all_count/union.meryl -peak ~{peak} -vcf vcf.reshaped.vcf -output out
