...
main() {
    ...
    read_bc1=$(dx upload read-BC_1.fastq.gz --brief --name="$read_bc1_name")
    read_bc2=$(dx upload read-BC_2.fastq.gz --brief --name="$read_bc2_name")
    ...
    scaffold=$(dx upload scaffolds.fasta.gz --brief --name="$scaffold_name")
